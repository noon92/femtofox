...
### Features
* Tiny size (63x54mm for the Kitchen Sink Edition, 65x30mm for the Smol Edition). Roughly equivalent to a Raspberry Pi hat and Pi Zero.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjg2NzIxMTkzLC04MDc2NjEyNjVdfQ==
-->