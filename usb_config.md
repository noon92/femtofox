...
|<center>⚠️<br>\_\_\_\_\_&nbsp;&nbsp;\_\_\_\_\_<br>2 long blinks, each lasting 1.5 seconds | USB drive mounted successfully but femtofox-config.txt contains the `dont_run_config_if_log_exists` line and a log is present on the USB drive... Ignoring.| Config file missing. | Create configuration file as described above. |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMDA4ODk2ODAsLTE3MTQ4NTcxNTddfQ
==
-->