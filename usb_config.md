...
|<center>⚠️<br>\_\_\_\_\_&nbsp;&nbsp;\_\_\_\_\_<br>2 long blinks, each lasting 1.5 seconds | USB drive mounted successfully but femtofox-config.txt contains `dont_run_if_log_exists="true"` and a log is present on the USB drive. Ignoring.| Misconfiguration. | Remove log from USB drive or remove `dont_run_if_log_exists` line from femtofox-config.txt |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTE4MzE2OTgsMTgxNjgzMzAxMiwxNz
kyOTA1ODk2LDQyNDg4ODY2OCwtMTcxNDg1NzE1N119
-->